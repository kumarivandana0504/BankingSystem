...
public class TransferDetails extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res)throws IOException, ServletException
	{
		...
		try
		{
			...
			out.println("<tr><th>ser no.</th><th>Name</th><th>Sender</th><th>Receiver</th><th>Amount</th><th>Date</th></tr>");
			int serno=1;
			while(rs.next())
			{
				out.println("<tr><td>"+serno+"</td><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)
